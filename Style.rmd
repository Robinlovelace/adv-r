...
Variable and function names should generally begin with lowercase characters. There are three
commonly used ways to separate words within a name:
"gooseneck" notation (`final_output`), "ant" notation (`final.output`) or 
[camelBack](http://en.wikipedia.org/wiki/CamelCase) (finalOutput). 
John Krushke recommends the latter, although the final choice is a matter of preference and readability.
Generally, variable names should be nouns and function names should be verbs. 
Strive for concise but meaningful names (this is not easy!)
